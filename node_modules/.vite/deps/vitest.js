...
var require_DOMElement = __commonJS({
  "node_modules/pretty-format/build/plugins/DOMElement.js"(exports) {
    ...
    var test3 = (val) => {
      var _a8;
      return ((_a8 = val == null ? void 0 : val.constructor) == null ? void 0 : _a8.name) && testNode(val);
    };
    exports.test = test3;
    ...
    (function(global3, factory) {
      ...
      function inspectTypedArray(array2, options) {
        ...
        for (var i = 0; i < array2.length; i++) {
          var string3 = "".concat(options.stylize(truncate(array2[i], options.truncate), "number")).concat(i === array2.length - 1 ? "" : ", ");
  ...
  "node_modules/diff-sequences/build/index.js"(exports) {
    ...
    var extendOverlappablePathsF = (d3, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, iMaxF, aIndexesR, iMaxR, division) => {
      ...
      for (let iF = 0, kF = -d3; iF <= nF; iF += 1, kF += 2) {
        const insert2 = iF === 0 || iF !== d3 && aIndexPrev1 < aIndexesF[iF];
    ...
    var extendOverlappablePathsR = (d3, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, iMaxF, aIndexesR, iMaxR, division) => {
      ...
      for (let iR = 0, kR = d3; iR <= nR; iR += 1, kR -= 2) {
        const insert2 = iR === 0 || iR !== d3 && aIndexesR[iR] < aIndexPrev1;
...
var require_compareByInspect = __commonJS({
  "node_modules/chai/lib/chai/utils/compareByInspect.js"(exports, module) {
    var inspect2 = require_inspect();
    module.exports = function compareByInspect(a2, b3) {
      return inspect2(a2) < inspect2(b3) ? -1 : 1;
    };
  }
});
...
var require_assertions = __commonJS({
  "node_modules/chai/lib/chai/core/assertions.js"(exports, module) {
    module.exports = function(chai3, _2) {
      var Assertion2 = chai3.Assertion, AssertionError2 = chai3.AssertionError, flag = _2.flag;
      [
        "to",
        "be",
        "been",
      ...
      function SameValueZero(a2, b3) {
        return _2.isNaN(a2) && _2.isNaN(b3) || a2 === b3;
      }
      ...
      function include(val, msg) {
        if (msg)
          flag(this, "message", msg);
        var obj = flag(this, "object"), objType = _2.type(obj).toLowerCase(), flagMsg = flag(this, "message"), negate = flag(this, "negate"), ssfi = flag(this, "ssfi"), isDeep = flag(this, "deep"), descriptor = isDeep ? "deep " : "";
        flagMsg = flagMsg ? flagMsg + ": " : "";
        var included = false;
        switch (objType) {
          case "string":
          ...
          case "weakset":
            ...
            break;
          case "map":
            var isEql = isDeep ? _2.eql : SameValueZero;
          ...
          case "set":
            if (isDeep) {
              obj.forEach(function(item) {
                included = included || _2.eql(item, val);
              });
            } else {
              included = obj.has(val);
            }
      ...
      function checkArguments() {
        var obj = flag(this, "object"), type2 = _2.type(obj);
        this.assert(
          "Arguments" === type2,
      ...
      function assertProperty(name, val, msg) {
        ...
        var isDeep = flag(this, "deep"), negate = flag(this, "negate"), pathInfo = isNested ? _2.getPathInfo(obj, name) : null, value = isNested ? pathInfo.value : obj[name];
        var descriptor = "";
        if (isDeep)
          descriptor += "deep ";
        if (isOwn)
        ...
        if (isOwn)
          ...
          hasProperty = _2.hasProperty(obj, name);
        ...
        if (arguments.length > 1) {
          this.assert(
            hasProperty && (isDeep ? _2.eql(val, value) : val === value),
      ...
      function assertOwnPropertyDescriptor(name, descriptor, msg) {
        ...
        if (actualDescriptor && descriptor) {
          this.assert(
            _2.eql(descriptor, actualDescriptor),
        ...
        if (any) {
          ok = expected.some(function(expectedKey) {
            return actual.some(function(actualKey) {
              if (isDeep) {
                return _2.eql(expectedKey, actualKey);
              } else {
      ...
      function respondTo(method, msg) {
        ...
        this.assert(
          ...
          "expected #{this} to respond to " + _2.inspect(method),
          "expected #{this} to not respond to " + _2.inspect(method)
        );
      }
      ...
      Assertion2.addMethod("members", function(subset, msg) {
        ...
        var cmp = flag(this, "deep") ? _2.eql : void 0;
        this.assert(
      ...
      function oneOf(list, msg) {
        ...
        if (contains) {
          ...
          if (isDeep) {
            this.assert(
              list.some(function(possibility) {
                return _2.eql(expected, possibility);
              }),
...
var import_loupe2 = __toESM(require_loupe());
...
function comparePrimitive(a2, b3, options) {
  ...
  const bFormat = (0, import_pretty_format3.format)(b3, FORMAT_OPTIONS);
...
function getObjectsDifference(a2, b3, formatOptions, options) {
  ...
  const bCompare = (0, import_pretty_format3.format)(b3, formatOptionsZeroIndent);
...
var import_pretty_format4 = __toESM(require_build());
var import_diff_sequences = __toESM(require_build2());
var import_loupe3 = __toESM(require_loupe());
...
function collectTask(task) {
  var _a8;
  (_a8 = collectorContext.currentSuite) == null ? void 0 : _a8.tasks.push(task);
}
...
function withTimeout(fn2, timeout, isHook = false) {
  ...
  return (...args) => {
    return Promise.race([fn2(...args), new Promise((resolve3, reject) => {
      ...
      (_a8 = timer.unref) == null ? void 0 : _a8.call(timer);
    })]);
  };
}
function createTestContext(test3, runner2) {
  ...
  return ((_a8 = runner2.extendTestContext) == null ? void 0 : _a8.call(runner2, context)) || context;
}
...
function formatTitle(template, items, idx) {
  ...
  if (isObject(items[0])) {
    formatted = formatted.replace(
      ...
      (_2, key) => {
        var _a8, _b5;
        return objDisplay(objectAttr(items[0], key), { truncate: (_b5 = (_a8 = runner == null ? void 0 : runner.config) == null ? void 0 : _a8.chaiConfig) == null ? void 0 : _b5.truncateThreshold });
      }
...
var E = typeof process < "u" && process.env && "development" || "";
var d = [["APPVEYOR"], ["AZURE_PIPELINES", "SYSTEM_TEAMFOUNDATIONCOLLECTIONURI"], ["AZURE_STATIC", "INPUT_AZURE_STATIC_WEB_APPS_API_TOKEN"], ["APPCIRCLE", "AC_APPCIRCLE"], ["BAMBOO", "bamboo_planKey"], ["BITBUCKET", "BITBUCKET_COMMIT"], ["BITRISE", "BITRISE_IO"], ["BUDDY", "BUDDY_WORKSPACE_ID"], ["BUILDKITE"], ["CIRCLE", "CIRCLECI"], ["CIRRUS", "CIRRUS_CI"], ["CLOUDFLARE_PAGES", "CF_PAGES", { ci: true }], ["CODEBUILD", "CODEBUILD_BUILD_ARN"], ["CODEFRESH", "CF_BUILD_ID"], ["DRONE"], ["DRONE", "DRONE_BUILD_EVENT"], ["DSARI"], ["GITHUB_ACTIONS"], ["GITLAB", "GITLAB_CI"], ["GITLAB", "CI_MERGE_REQUEST_ID"], ["GOCD", "GO_PIPELINE_LABEL"], ["LAYERCI"], ["HUDSON", "HUDSON_URL"], ["JENKINS", "JENKINS_URL"], ["MAGNUM"], ["NETLIFY"], ["NETLIFY", "NETLIFY_LOCAL", { ci: false }], ["NEVERCODE"], ["RENDER"], ["SAIL", "SAILCI"], ["SEMAPHORE"], ["SCREWDRIVER"], ["SHIPPABLE"], ["SOLANO", "TDDIUM"], ["STRIDER"], ["TEAMCITY", "TEAMCITY_VERSION"], ["TRAVIS"], ["VERCEL", "NOW_BUILDER"], ["VERCEL", "VERCEL", { ci: false }], ["VERCEL", "VERCEL_ENV", { ci: false }], ["APPCENTER", "APPCENTER_BUILD_ID"], ["CODESANDBOX", "CODESANDBOX_SSE", { ci: false }], ["STACKBLITZ"], ["STORMKIT"], ["CLEAVR"]];
function B() {
...
var _a;
var l = ((_a = globalThis.process) == null ? void 0 : _a.platform) || "";
var T = n(s.CI) || I.ci !== false;
var _a2, _b;
var a = n(((_a2 = globalThis.process) == null ? void 0 : _a2.stdout) && ((_b = globalThis.process) == null ? void 0 : _b.stdout.isTTY));
var P = n(s.DEBUG);
var c = E === "test" || n(s.TEST);
var m = n(s.MINIMAL) || T || c || !a;
var C = /^win/i.test(l);
var M = /^linux/i.test(l);
var V = /^darwin/i.test(l);
var y = !n(s.NO_COLOR) && (n(s.FORCE_COLOR) || C && s.TERM !== "dumb" || a && s.TERM && s.TERM === "dumb" || T);
var _a3, _b2;
var R = (((_b2 = (_a3 = globalThis.process) == null ? void 0 : _a3.versions) == null ? void 0 : _b2.node) || "").replace(/^v/, "") || null;
var w = Number(R == null ? void 0 : R.split(".")[0]) || null;
var Y = globalThis.process || /* @__PURE__ */ Object.create(null);
var L = { versions: {} };
var G = new Proxy(Y, { get(e, o) {
  if (o === "env")
    return s;
  if (o in e)
    return e[o];
...
var _ = !!globalThis.Netlify;
var O = !!globalThis.EdgeRuntime;
var _a4;
var D = ((_a4 = globalThis.navigator) == null ? void 0 : _a4.userAgent) === "Cloudflare-Workers";
var A = !!globalThis.Deno;
var u = !!globalThis.__lagon__;
var _a5, _b3;
var N = ((_b3 = (_a5 = globalThis.process) == null ? void 0 : _a5.release) == null ? void 0 : _b3.name) === "node";
var _a6, _b4;
var S = !!globalThis.Bun || !!((_b4 = (_a6 = globalThis.process) == null ? void 0 : _a6.versions) == null ? void 0 : _b4.bun);
var b = !!globalThis.fastly;
var K = [[_, "netlify"], [O, "edge-light"], [D, "workerd"], [A, "deno"], [u, "lagon"], [N, "node"], [S, "bun"], [b, "fastly"]];
function F() {
...
var C2 = (e) => (d2(e, u2, { value: { reset: () => M2(e[u2]) } }), e[u2]);
var v = (e) => e[u2] || C2(e);
function T2(e) {
  m2(y2("function", e) || y2("undefined", e), "cannot spy on a non-function value");
  let t2 = function(...a2) {
    let r2 = v(t2);
    r2.called = true, r2.callCount++, r2.calls.push(a2);
    let i = r2.next.shift();
    if (i) {
      r2.results.push(i);
      let [s2, l2] = i;
    ...
    if (r2.impl)
      try {
        new.target ? o = Reflect.construct(r2.impl, a2, new.target) : o = r2.impl.apply(this, a2), c2 = "ok";
      } catch (s2) {
        throw o = s2, c2 = "error", r2.results.push([c2, s2]), s2;
      }
    let x = [c2, o];
    if (b2(o)) {
      let s2 = o.then((l2) => x[1] = l2).catch((l2) => {
        throw x[0] = "error", x[1] = l2, l2;
      });
      Object.assign(s2, o), o = s2;
    }
    return r2.results.push(x), o;
  };
  p(t2, "_isMockFunction", true), p(t2, "length", e ? e.length : 0), p(t2, "name", e && e.name || "spy");
  let n2 = v(t2);
  return n2.reset(), n2.impl = e, t2;
}
var P2 = (e, t2) => Object.getOwnPropertyDescriptor(e, t2);
function E2(e, t2, n2) {
  m2(!y2("undefined", e), "spyOn could not find an object to spy upon"), m2(y2("object", e) || y2("function", e), "cannot spyOn on a primitive value");
  let a2 = () => {
    if (!y2("object", t2))
      return [t2, "value"];
  ...
  }, [r2, i] = a2(), o = P2(e, r2), c2 = Object.getPrototypeOf(e), x = c2 && P2(c2, r2), s2 = o || x;
  m2(s2 || r2 in e, `${String(r2)} does not exist`);
  let l2 = false;
  i === "value" && s2 && !s2.value && s2.get && (i = "get", l2 = true, n2 = s2.get());
  let f;
  s2 ? f = s2[i] : i !== "value" ? f = () => e[r2] : f = e[r2], n2 || (n2 = f);
  let S2 = T2(n2), O2 = (w2) => {
    let { value: G2, ...k } = s2 || {
      configurable: true,
      writable: true
    };
    i !== "value" && delete k.writable, k[i] = w2, d2(e, r2, k);
  }, K2 = () => s2 ? d2(e, r2, s2) : O2(f), A2 = S2[u2];
  return p(A2, "restore", K2), p(A2, "getOriginal", () => l2 ? f() : f), p(A2, "willCall", (w2) => (A2.impl = w2, S2)), O2(l2 ? () => S2 : S2), I2.add(S2), S2;
}
...
function fn(implementation) {
  const enhancedSpy = enhanceSpy(E2({ spy: implementation || (() => {
  }) }, "spy"));
  if (implementation)
...
function eq(a2, b3, aStack, bStack, customTesters, hasKey2) {
  ...
  for (let i = 0; i < customTesters.length; i++) {
    const customTesterResult = customTesters[i](a2, b3);
...
function iterableEquality(a2, b3, aStack = [], bStack = []) {
  ...
  if (a2.size !== void 0) {
    if (a2.size !== b3.size) {
      ...
      for (const aEntry of a2) {
        if (!b3.has(aEntry[0]) || !equals(aEntry[1], b3.get(aEntry[0]), [iterableEqualityWithStack])) {
          let has = false;
...
function sparseArrayEquality(a2, b3) {
  if (!Array.isArray(a2) || !Array.isArray(b3))
    return void 0;
  const aKeys = Object.keys(a2);
  const bKeys = Object.keys(b3);
  return equals(a2, b3, [iterableEquality, typeEquality], true) && equals(aKeys, bKeys);
}
...
function wrapSoft(utils, fn2) {
  return function(...args) {
    ...
    try {
      ...
      (_a8 = test3.result).errors || (_a8.errors = []);
...
var JestChaiExpect = (chai3, utils) => {
  ...
  ["throw", "throws", "Throw"].forEach((m3) => {
    utils.overwriteMethod(chai3.Assertion.prototype, m3, (_super) => {
      return function(...args) {
...
${spy.mock.calls.map((callArg, i) => {
        let methodCall = c2().bold(`  ${ordinalOf(i + 1)} ${spy.getMockName()} call:
...
${spy.mock.results.map((callReturn, i) => {
      let methodCall = c2().bold(`  ${ordinalOf(i + 1)} ${spy.getMockName()} call return:
...
var import_pretty_format5 = __toESM(require_build());
...
var naturalCompare$1 = getDefaultExportFromCjs2(naturalCompareExports);
...
function prepareExpected(expected) {
  function findStartIndent() {
    ...
    const objectIndent = (_a8 = matchObject == null ? void 0 : matchObject[1]) == null ? void 0 : _a8.length;
    if (objectIndent)
      return objectIndent;
    const matchText = /^\n( +)"/.exec(expected || "");
...
function sortComparator$1(a2, b3) {
  return a2[0] - b3[0];
}
var schemeRegex = /^[\w+.-]+:\/\//;
var urlRegex = /^([\w+.-]+:)\/\/([^@/#?]*@)?([^:/#?]*)(:\d+)?(\/[^#?]*)?(\?[^#]*)?(#.*)?/;
...
function parseStacktrace(stack, options = {}) {
  ...
  return stacks.map((stack2) => {
    var _a8;
    const map2 = (_a8 = options.getSourceMap) == null ? void 0 : _a8.call(options, stack2.file);
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-4JSGIGCN.js")).default;
...
var SnapshotClient = class {
  ...
  async setTest(filepath, name, options) {
    ...
    this.name = name;
    if (((_a8 = this.snapshotState) == null ? void 0 : _a8.testFilePath) !== filepath) {
      this.resetCurrent();
  ...
  skipTestSnapshots(name) {
    var _a8;
    (_a8 = this.snapshotState) == null ? void 0 : _a8.markSnapshotsAsCheckedForTest(name);
  }
  /**
...
function sortComparator$12(a2, b3) {
  return a2[0] - b3[0];
}
var UrlType2;
(function(UrlType3) {
...
var MockDate = class extends RealDate {
  constructor(y3, m3, d3, h, M3, s2, ms) {
    super();
    let date;
    switch (arguments.length) {
      ...
      default:
        ...
        s2 = s2 || 0;
        ms = ms || 0;
        date = new RealDate(y3, m3, d3, h, M3, s2, ms);
        break;
    }
    return date;
  }
...
var Subset = getDefaultExportFromCjs(chaiSubsetExports);
...
var SnapshotPlugin = (chai3, utils) => {
  const getTestNames = (test3) => {
    ...
    if (!test3)
      return {};
    return {
      filepath: (_a8 = test3.file) == null ? void 0 : _a8.filepath,
  ...
  utils.addMethod(
    ...
    function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
      var _a8;
      const test3 = utils.flag(this, "vitest-test");
      const isInsideEach = test3 && (test3.each || ((_a8 = test3.suite) == null ? void 0 : _a8.each));
      if (isInsideEach)
...
function createExpect(test3) {
  ...
  setState({
    ...
    testPath: test3 ? (_a8 = test3.suite.file) == null ? void 0 : _a8.filepath : globalState.testPath,
